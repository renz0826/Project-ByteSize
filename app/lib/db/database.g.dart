...
class $PatientTable extends Patient with TableInfo<$PatientTable, PatientData> {
  ...
  List<GeneratedColumn> get $columns =>
      [id, name, age, sex, address, contactNumber];
  @override
...
class $AppointmentTable extends Appointment
  ...
  static const VerificationMeta _dentistIDMeta =
      const VerificationMeta('dentistID');
  @override
  late final GeneratedColumn<int> dentistID = GeneratedColumn<int>(
      'dentist_i_d', aliasedName, false,
      type: DriftSqlType.int,
      requiredDuringInsert: true,
      defaultConstraints:
          GeneratedColumn.constraintIsAlways('REFERENCES dentist (id)'));
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, patientID, dentistID, date, time, status];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  VerificationContext validateIntegrity(Insertable<AppointmentData> instance,
    ...
    if (data.containsKey('dentist_i_d')) {
      context.handle(
          _dentistIDMeta,
          dentistID.isAcceptableOrUnknown(
              data['dentist_i_d']!, _dentistIDMeta));
    } else if (isInserting) {
  ...
  AppointmentData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return AppointmentData(
      ...
      dentistID: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}dentist_i_d'])!,
...
class BillingData extends DataClass implements Insertable<BillingData> {
  ...
  BillingData copyWithCompanion(BillingCompanion data) {
    return BillingData(
      ...
      realAmount:
          data.realAmount.present ? data.realAmount.value : this.realAmount,
  ...
  int get hashCode => Object.hash(
      id, appointmentID, totalAmount, realAmount, paymentMethod, paymentStatus);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $PatientRecordTable extends PatientRecord
  ...
  late final GeneratedColumn<String> emergencyContactNo =
      GeneratedColumn<String>('emergency_contact_no', aliasedName, false,
          additionalChecks: GeneratedColumn.checkTextLength(
              minTextLength: 10, maxTextLength: 10),
          type: DriftSqlType.string,
          requiredDuringInsert: true);
  ...
  late final GeneratedColumn<String> emergencyContactRelation =
      GeneratedColumn<String>('emergency_contact_relation', aliasedName, false,
          type: DriftSqlType.string, requiredDuringInsert: true);
  ...
  @override
  VerificationContext validateIntegrity(Insertable<PatientRecordData> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
    ...
    if (data.containsKey('emergency_contact_no')) {
      ...
      context.missing(_emergencyContactNoMeta);
    }
...
class PatientRecordData extends DataClass
  ...
  factory PatientRecordData.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return PatientRecordData(
      id: serializer.fromJson<int>(json['id']),
...
final class $$PatientTableReferences
  ...
  static MultiTypedResultKey<$PatientRecordTable, List<PatientRecordData>>
      _patientRecordRefsTable(_$AppDatabase db) =>
          MultiTypedResultKey.fromTable(db.patientRecord,
              aliasName: $_aliasNameGenerator(
                  db.patient.id, db.patientRecord.patientID));

  $$PatientRecordTableProcessedTableManager get patientRecordRefs {
    final manager = $$PatientRecordTableTableManager($_db, $_db.patientRecord)
        .filter((f) => f.patientID.id.sqlEquals($_itemColumn<int>('id')!));
...
class $$PatientTableTableManager extends RootTableManager<
    ...
    PrefetchHooks Function(
        {bool appointmentRefs, bool dentalChartRefs, bool patientRecordRefs})> {
...
final class $$DentistTableReferences
  ...
  static MultiTypedResultKey<$AppointmentTable, List<AppointmentData>>
      _appointmentRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
          db.appointment,
          aliasName:
              $_aliasNameGenerator(db.dentist.id, db.appointment.dentistID));
...
class $$DentistTableTableManager extends RootTableManager<
  ...
  $$DentistTableTableManager(_$AppDatabase db, $DentistTable table)
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map((e) =>
                  (e.readTable(table), $$DentistTableReferences(db, table, e)))
              .toList(),
          prefetchHooksCallback: ({appointmentRefs = false}) {
            return PrefetchHooks(
              ...
              getPrefetchedDataCallback: (items) async {
                return [
                  if (appointmentRefs)
                    await $_getPrefetchedData<DentistData, $DentistTable,
                            AppointmentData>(
                        currentTable: table,
                        referencedTable:
                            $$DentistTableReferences._appointmentRefsTable(db),
                        managerFromTypedResult: (p0) =>
                            $$DentistTableReferences(db, table, p0)
                                .appointmentRefs,
                        referencedItemsForCurrentItem:
                            (item, referencedItems) => referencedItems
                                .where((e) => e.dentistID == item.id),
                        typedResults: items)
                ];
              },
            );
...
final class $$AppointmentTableReferences
  ...
  $$DentistTableProcessedTableManager get dentistID {
    ...
    final manager = $$DentistTableTableManager($_db, $_db.dentist)
        .filter((f) => f.id.sqlEquals($_column));
  ...
  static MultiTypedResultKey<$BillingTable, List<BillingData>>
      _billingRefsTable(_$AppDatabase db) =>
          MultiTypedResultKey.fromTable(db.billing,
              aliasName: $_aliasNameGenerator(
                  db.appointment.id, db.billing.appointmentID));
              ...
              addJoins: <
                ...
                if (dentistID) {
                  state = state.withJoin(
                    ...
                    referencedTable:
                        $$AppointmentTableReferences._dentistIDTable(db),
                    referencedColumn:
                        $$AppointmentTableReferences._dentistIDTable(db).id,
                  ) as T;
                }
                ...
                return [
                  if (billingRefs)
                    await $_getPrefetchedData<AppointmentData,
                            $AppointmentTable, BillingData>(
                        currentTable: table,
                        referencedTable:
                            $$AppointmentTableReferences._billingRefsTable(db),
                        managerFromTypedResult: (p0) =>
...
class $$BillingTableFilterComposer
  ...
  ColumnFilters<double> get realAmount => $composableBuilder(
      column: $table.realAmount, builder: (column) => ColumnFilters(column));
...
class $$BillingTableOrderingComposer
  ...
  ColumnOrderings<double> get realAmount => $composableBuilder(
      column: $table.realAmount, builder: (column) => ColumnOrderings(column));
...
class $$BillingTableAnnotationComposer
  ...
  GeneratedColumn<double> get realAmount => $composableBuilder(
      column: $table.realAmount, builder: (column) => column);
              ...
              addJoins: <
                ...
                if (appointmentID) {
                  state = state.withJoin(
                    ...
                    referencedTable:
                        $$BillingTableReferences._appointmentIDTable(db),
                    referencedColumn:
                        $$BillingTableReferences._appointmentIDTable(db).id,
                  ) as T;
                }
...
typedef $$TreatmentRecordTableProcessedTableManager = ProcessedTableManager<
    ...
    TreatmentRecordData,
    PrefetchHooks Function({bool appointmentID})>;
typedef $$PatientRecordTableCreateCompanionBuilder = PatientRecordCompanion
    Function({
  Value<int> id,
  required int patientID,
  Value<String> allergies,
...
typedef $$PatientRecordTableUpdateCompanionBuilder = PatientRecordCompanion
    Function({
  Value<int> id,
  Value<int> patientID,
  Value<String> allergies,
...
final class $$PatientRecordTableReferences extends BaseReferences<_$AppDatabase,
    $PatientRecordTable, PatientRecordData> {
...
class $$PatientRecordTableAnnotationComposer
  ...
  GeneratedColumn<String> get emergencyContactRelation => $composableBuilder(
      column: $table.emergencyContactRelation, builder: (column) => column);
...
class $$PatientRecordTableTableManager extends RootTableManager<
    _$AppDatabase,
    $PatientRecordTable,
    PatientRecordData,
    $$PatientRecordTableFilterComposer,
              ...
              addJoins: <
                ...
                if (patientID) {
                  state = state.withJoin(
                    ...
                    currentColumn: table.patientID,
                    referencedTable:
                        $$PatientRecordTableReferences._patientIDTable(db),
                    referencedColumn:
                        $$PatientRecordTableReferences._patientIDTable(db).id,
                  ) as T;
                }
...
typedef $$PatientRecordTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $PatientRecordTable,
    PatientRecordData,
    $$PatientRecordTableFilterComposer,
